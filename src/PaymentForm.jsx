          ...
          <form onSubmit={formik.handleSubmit} className="UI-form space-y-4">
            ...
            <div className="Field">
              ...
              <div className="Field-content">
                <input
                  type="text"
                  name="name"
                  className={`Field-el w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${formik.errors.name && formik.touched.name ? 'border-red-500' : 'border-gray-300'
                    }`}
            ...
            <div className="Field">
              ...
              <div className="Field-content">
                <input
                  type="email"
                  name="email"
                  className={`Field-el w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${formik.errors.email && formik.touched.email ? 'border-red-500' : 'border-gray-300'
                    }`}
            ...
            <div className="Field">
              ...
              <div className="Field-content">
                <input
                  type="tel"
                  name="phone"
                  className={`Field-el w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${formik.errors.phone && formik.touched.phone ? 'border-red-500' : 'border-gray-300'
                    }`}
              ...
              <div className="Field-content">
                <div className="relative">
                  <input
                    ...
                    name="collegeName"
                    list="collegeOptions"
                    className={`Field-el w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${formik.errors.collegeName && formik.touched.collegeName ? 'border-red-500' : 'border-gray-300'
                      }`}
            ...
            <div className="Field">
              ...
              <div className="Field-content">
                <input
                  type="text"
                  name="collegeCode"
                  className={`Field-el w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${formik.errors.collegeCode && formik.touched.collegeCode ? 'border-red-500' : 'border-gray-300'
                    }`}
              ...
              <div className="Field-content">
                <div className="relative">
                  <input
                    ...
                    className={`Field-el w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${formik.errors.department && formik.touched.department ? 'border-red-500' : 'border-gray-300'
                      }`}
            ...
            <div className="Field">
              ...
              <div className="Field-content">
                <select
                  name="semester"
                  className={`Field-el w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${formik.errors.semester && formik.touched.semester ? 'border-red-500' : 'border-gray-300'
                    }`}
            ...
            <div className="Field">
              ...
              <div className="Field-content">
                <input
                  type="text"
                  name="rollNumber"
                  className={`Field-el w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${formik.errors.rollNumber && formik.touched.rollNumber ? 'border-red-500' : 'border-gray-300'
                    }`}
            ...
            <div className="Field">
              ...
              <div className="Field-content">
                <select
                  name="program"
                  className={`Field-el w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${formik.errors.program && formik.touched.program ? 'border-red-500' : 'border-gray-300'
                    }`}
